...
public class AdvBadOwnerRegister  extends AppCompatActivity implements  View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_ilgam_req:
                if(checkData()) {
                    showConfirmDialog("악덕업주" , "악덕업주를 등록하시겠습니까?");
                }
                break;
        }
    }
