...
public class AdvIlterRegister  extends AppCompatActivity implements  View.OnClickListener {
    ...
    private String[] spinnerItem = new String[] {"1" , "2" ,"3" , "4" , "5" , "6" , "7"};
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.adv_ilter_register);
        ...
        switch (v.getId()) {
            ...
            case R.id.btn_ilgam_req:
                if(checkData()) {
                    ...
                    showConfirmDialog("일터나누기" , "일터나누기를 등록하시겠습니까? \n 등록 시 "+minus_point+" 포인트가 차감됩니다.");
                }
                break;
        }
    }
    ...
    private void registerIlgam() {
        ...
        adverModel.setType("2");    // 일터등록 타입은 2
...
//                    progressDialog.dismiss();
    ...
    private boolean checkData() {
        ...
        Log.d("Restapi" , "api : " + "Spinner " + spinner.getSelectedItem().toString());
