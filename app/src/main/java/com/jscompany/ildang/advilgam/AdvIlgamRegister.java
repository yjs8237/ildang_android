...
public class AdvIlgamRegister  extends AppCompatActivity implements  View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.adv_ilgam_register);
        ...
        switch (v.getId()) {
            ...
            case R.id.btn_ilgam_req:
                if(checkData()) {
                    ...
                    showConfirmDialog("일감/일터 나누기" , "일감/일터 나누기를 등록하시겠습니까? \n 등록 시 "+minus_point+" 포인트가 차감됩니다.");
                }
                break;
        }
    }
    ...
    private void registerIlgam() {
        ...
        adverModel.setType("1");    // 일감/ 일터 등록 타입은 1
